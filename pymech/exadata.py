                            ...
                            for iface1 in range(nfaces):
                                ...
                                if bc1 != "E" and not (ignore_empty and bc1 == ""):
                                    ...
                                    if dist2 <= tol ** 2:
                                        ...
                                        if bc == "P" and bc1 == "P":
                                            iel_p = (
                                                int(self.elem[iel].bcs[0, iface][3]) - 1
                                            )
                                            iel_p1 = (
                                                int(self.elem[iel1].bcs[0, iface1][3])
                                                - 1
                                            )
                                            iface_p = (
                                                int(self.elem[iel].bcs[0, iface][4]) - 1
                                            )
                                            iface_p1 = (
                                                int(self.elem[iel1].bcs[0, iface1][4])
                                                - 1
                                            )
                                            for ibc in range(nbc):
                                                self.elem[iel_p].bcs[ibc, iface_p][
                                                    0
                                                ] = "P"
                                                self.elem[iel_p1].bcs[ibc, iface_p1][
                                                    0
                                                ] = "P"
                                                self.elem[iel_p].bcs[ibc, iface_p][
                                                    3
                                        ...
                                        for ibc in range(nbc):
                                            ...
                                            self.elem[iel1].bcs[ibc, iface1][3] = (
                                                iel + 1
                                            )
                                            self.elem[iel].bcs[ibc, iface][4] = (
                                                iface1 + 1
                                            )
                                            self.elem[iel1].bcs[ibc, iface1][4] = (
                                                iface + 1
                                            )
                                        nchanges = nchanges + 1
